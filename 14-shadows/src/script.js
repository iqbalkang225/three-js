...
const spotLight = new THREE.SpotLight(0xffffff, 3.6, 10, 10);
...
const help = new THREE.CameraHelper(spotLight.shadow.camera);
// scene.add(help);
...
const shadowPlane = new THREE.Mesh(
  ...
  new THREE.MeshBasicMaterial({ transparent: true, color: 0x000000, alphaMap: simpleShadowTexture })
);
